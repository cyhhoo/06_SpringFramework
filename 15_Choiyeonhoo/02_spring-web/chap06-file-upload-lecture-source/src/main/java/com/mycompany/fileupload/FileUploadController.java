...
public class FileUploadController {
  ...
  /* Applictaion.yml 파일에서 파일 경로 얻어오기 */
  ...
  public String multiFileUploadDB(
    ...
    try {
      for(MultipartFile singleFile : multiFile){
        ...
        // FileDTO 생성
        FileDTO f = new FileDTO(singleFile.getOriginalFilename(),
                                savedName,
                                filePath,
  ...
  // - 네트워크상에서 중복되지 않는 유일한 아이디를 만들때 사용하는 표준 규약
  // - 128bit 숫자로 이루어짐(출력 시 16 진수로 변환되서 보임)
